...
export default function Comment({ data }) {
  ...
  return (
    <div className="flex gap-3 bg-[#0f0f0f] border border-gray-800 hover:border-gray-700 transition-all duration-200 m-2 p-4 rounded-2xl w-full shadow-md shadow-black/20">
      <img
      ...
      <div className="flex-1">
        <p className="font-semibold text-gray-100">{authorDisplayName}</p>
        <p
          className="text-gray-300 leading-relaxed mt-1"
        ...
        {showReplies && (
          <div className="mt-3 border-l-2 border-gray-700 pl-4">
